...
using LocadoraDeVeiculos.Aplicacao.ModuloAutenticacao.Commands.Rotacionar;
using LocadoraDeVeiculos.Aplicacao.ModuloAutenticacao.Commands.Sair;
...
[Route("api/auth")]
public class AuthController(IMediator mediator) : MainController
{
    [HttpPost("registrar")]
